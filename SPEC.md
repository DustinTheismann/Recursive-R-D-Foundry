...
hand-written variants (`gate_demo/agents.py`); **successor generation is
...
and policy engine. The foundry contributes only the wiring (`gate_demo/gate.py`).
...
## 4. Falsification conditions (live — run `make demo-gate`)
