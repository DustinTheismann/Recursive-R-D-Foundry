...
So ``python -m foundry`` (or ``make demo`` / ``make falsify``) *is* the
...
from foundry.agents import CANDIDATES
from foundry.gate import attempt_promotion, evaluate_candidate
